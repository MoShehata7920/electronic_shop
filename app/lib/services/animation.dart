...
extension AnimatedWidgetExtension on Widget {
  Widget animateOnPageLoad(
      {int msDelay = 0, double dx = 0, double dy = 0, showDelay = 0}) {
    AnimationInfo animationInfo =
        getDefaultAnimation(msDelay, dx, dy, showDelay);
    return Animate(
        controller:
...
AnimationInfo getDefaultAnimation(
    int msDelay, double dx, double dy, int showDelay) {
